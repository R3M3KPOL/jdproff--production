...
<body>
    <div class="layout-position">
        <aside data-name="sezon-offert" class="summer-offert">
            <button data-name="summer-btn" class="summer-offert__button">
                <img class="summer-offert__svg" src="./src/img/photo/svg icon/bell-regular.svg" alt="">
                <span data-name="offert-btn-close" class="summer-offert--closed"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 470 512">
                        <path fill="currentColor" d="M310.6 361.4c12.5 12.5 12.5 32.75 0 45.25C304.4 412.9 296.2 416 288 416s-16.38-3.125-22.62-9.375L160 301.3L54.63 406.6C48.38 412.9 40.19 416 32 416S15.63 412.9 9.375 406.6c-12.5-12.5-12.5-32.75 0-45.25l105.4-105.4L9.375 150.6c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L160 210.8l105.4-105.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-105.4 105.4L310.6 361.4z" />
                    </svg></span>
            </button>
            <figure data-name="summer-container" class="summer-offert__container invisible">
                <figcaption class="summer-offert__title title-heading">Takmaling – sommertilbud</figcaption>
                <img class="summer-offert__img" src="./src/img/photo/inne/sommer kampanje.jpg" alt="">
                <p class="summer-offert__text">Takutskifting er en veldig stor utgift som alle ønsker å unngå, selv
                    om det ikke
                    alltid er mulig. Du kan imidlertid spare mye penger ved å ta vare på dekningen regelmessig og
                    opprettholde
                    den. Takvedlikehold kan koste opptil flere titalls ganger mindre enn erstatningen. Rengjøring,
                    impregnering
                    og maling av taket noen få år (og under gunstige forhold til hvert dusinvis år) gjør det mulig å
                    forlenge
                    levetiden av taket med et dusin eller til og med flere dusin påfølgende sesonger</p>
                <p class="summer-offert__text">Derfor vil vi tilby våre takmalingstjenester. Tilbudet er
                    tilgjengelig om
                    sommeren, og vi inviterer deg til å bruke tjenestene våre. All informasjon angående:
                    servicekostnader,
                    implementeringstid og ytelse, vennligst kom i kontakt med oss gjennom telefon eller e-post.</p>
            </figure>
        </aside>
        <div class="grid-container">
            ...
            <section class="video-section">
                <video class="video-section__box" playsinline="" autoplay="" loop="" muted="">
                    <source src=".\src\video\work-planning.mp4" type="video/mp4" alt="Analyse av leilighet plantegning">
                    <source src=".\src\video\work-planning.mp4" type="video/webm" alt="Analyse av leilighet plantegning">
                    <source src=".\src\video\work-planning.mp4" type="video/ogv" alt="Analyse av leilighet plantegning">
                </video>
                <header class="video-section__heading">
                    ...
                    <ul class="video-section__sm">
                        ...
                        <li class="video-section__icon"><a href="https://www.facebook.com/JD-PROFF-100158098863016"><svg class="video-section__icon--fb" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                    <path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z" />
                                </svg></a></li>
                        <li class="video-section__icon"><a href="https://www.instagram.com/jdproff/"><svg class="video-section__icon--instagram" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                        ...
                        <li class="video-section__icon"><a href="mailto:kontor@jdproff.no"><svg class="video-section__icon--email" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <div class="video-section__more">
                        ...
                        <span class="video-section__box-text"><a class="video-section__text--more" href="index.php#top">Les mer...</a></span>
                    </div>
                </header>
            </section>
            <main class="main">
                <div data-name="popup" class="popup hidden">
                    <div class="popup__photo">
                        ...
                        <figure class="popup__figures">
                            <img data-name="popup-picture" src="" alt="">
                ...
                <section class="slider-gallery">
                    <div class="slider-gallery--overflow-center">
                        <figure class="slider-gallery__container">
                            <figure data-name='images-carousel' class="slider-gallery__figure"><img class="slider-gallery__photo" src="./src/img/photo/slider gallery - all photos(300width)/malowanie domu przed-small.jpg" alt=""></figure>
                            <figure data-name='images-carousel' class="slider-gallery__figure"><img class="slider-gallery__photo" src="./src/img/photo/slider gallery - all photos(300width)/malowanie domu po-small.jpg" alt=""></figure>
                            <figure data-name='images-carousel' class="slider-gallery__figure"><img class="slider-gallery__photo" src="./src/img/photo/slider gallery - all photos(300width)/patio czerwone przed - small.jpg" alt=""></figure>
                            <figure data-name='images-carousel' class="slider-gallery__figure"><img class="slider-gallery__photo" src="./src/img/photo/slider gallery - all photos(300width)/patio czerwone po - small.jpg" alt=""></figure>
                            <figure data-name='images-carousel' class="slider-gallery__figure"><img class="slider-gallery__photo" src="./src/img/photo/slider gallery - all photos(300width)/patio przed(2) - small.jpg" alt=""></figure>
                            <figure data-name='images-carousel' class="slider-gallery__figure"><img class="slider-gallery__photo" src="./src/img/photo/slider gallery - all photos(300width)/patio po (2) - small.jpg" alt="">
                            </figure>
                            <figure data-name='images-carousel' class="slider-gallery__figure"><img class="slider-gallery__photo" src="./src/img/photo/slider gallery - all photos(300width)/patio przed - small.jpg" alt="">
                            </figure>
                            <figure data-name='images-carousel' class="slider-gallery__figure"><img class="slider-gallery__photo" src="./src/img/photo/slider gallery - all photos(300width)/patio po - przód - small.jpg" alt=""></figure>
                            <figure data-name='images-carousel' class="slider-gallery__figure"><img class="slider-gallery__photo" src="./src/img/photo/slider gallery - all photos(300width)//patio po - bok - small.jpg" alt=""></figure>
                            <figure data-name='images-carousel' class="slider-gallery__figure"><img class="slider-gallery__photo" src="./src/img/photo/slider gallery - all photos(300width)/pomieszczenie przed - small.jpg" alt=""></figure>
                            <figure data-name='images-carousel' class="slider-gallery__figure"><img class="slider-gallery__photo" src="./src/img/photo/slider gallery - all photos(300width)/pomieszczenie w trakcie - small.jpg" alt=""></figure>
                            <figure data-name='images-carousel' class="slider-gallery__figure"><img class="slider-gallery__photo" src="./src/img/photo/slider gallery - all photos(300width)/pomieszczenie po - small.jpg" alt=""></figure>
                            <figure data-name='images-carousel' class="slider-gallery__figure"><img class="slider-gallery__photo" src="./src/img/photo/slider gallery - all photos(300width)/tarasik przed - small.jpg" alt=""></figure>
                            <figure data-name='images-carousel' class="slider-gallery__figure"><img class="slider-gallery__photo" src="./src/img/photo/slider gallery - all photos(300width)/tarasik po - small.jpg" alt="">
                            </figure>
                        </figure>
                        
                        <a class="slider-gallery__btn" href="gallery.php">
                            vise mer...</a>
                    </div>
                </section>

                <section class="why-us wrapper-style">
                    <h2 data-text="HVORFOR BØR DU STOLE" class="why-us__title title-heading">HVORFOR BØR DU STOLE PÅ
                        OSS?
                    </h2>
                    <section class="why-us__container">
                        ...
                        <picture class="why-us__jpg why-us__jpg--first" data-name="images-right">
                            ...
                            <img loading="lazy" data-src="./src/img/photo/biały-domek-patio/biały-domek-patio-przód-500.jpg" src="https://via.placeholder.com/350" alt="en plan av en leilighet som ligger på et trebord" class="whyUs__item-img">
                        </picture>
                        ...
                        <picture class="why-us__jpg why-us__jpg--second" data-name="images">
                            ...
                            <img data-src="./src/img/photo/biały-domek-patio/biały-domek-patio-w-trakcie-500.jpg" src="https://via.placeholder.com/350" alt="en plan av en leilighet som ligger på et trebord" class="whyUs__item-img">
                        </picture>
                    </section>
                    <section class="why-us__container">
                        <header class="why-us__header">
                        ...
                        <picture class="why-us__jpg why-us__jpg--third" data-name="images">
                            ...
                            <img loading="lazy" data-src="./src/img/photo/tarasy/taras-w-trakcie-500.jpg" src="https://via.placeholder.com/350" alt="" class="why-us__item-img">
                        </picture>
                        <picture class="why-us__jpg why-us__jpg--fourth" data-name="images-left">
                            ...
                            <img loading="lazy" data-src="./src/img/photo/tarasy/taras-po-500.jpg" src="https://via.placeholder.com/350" alt="" class="why-us__item-img">
                        </picture>
                    ...
                    <section class="why-us__container">
                        ...
                        <picture class="why-us__jpg why-us__jpg--fifth" data-name="images-bottom">
                            <source media="(max-width: 767px)" data-srcset="./src/img/photo/inne/img-300-small/łazienka-przed-300.webp" srcset="">
                            <img loading="lazy" data-src="./src/img/photo/remont-łazienki-2/remont-dużej-łazienki-500.jpg" src="https://via.placeholder.com/350" alt="">
                        </picture>
                        <picture class="why-us__jpg why-us__jpg--sixth" data-name="images">
                            <source media="(max-width: 767px)" data-srcset="./src/img/photo/inne/img-300-small/łazienka-po-300.webp" srcset="">
                            <img loading="lazy" data-src="./src/img/photo/remont-łazienki-2/po-remoncie-dużej-łazienki-500.jpg" src="https://via.placeholder.com/350" alt="" class="why-us__item-img">
                        </picture>
                    </section>
                    <section class="why-us__container">
                        <header class="why-us__header why-us__header--grid-col-3">
                            <h3 class="why-us__subtitle sub-title">God kundeservice</h3>
                            <p class="why-us__item-text tekst-box fade-in">Vi tilbyr høflige og profesjonelle tjenester
                                og
                        ...
                        <picture class="why-us__jpg why-us__jpg--seventh" data-name="images-right">
                            ...
                            <img loading="lazy" data-src="./src/img/photo/biały-domek-duże-patio/biały-domek-przed-500.jpg" src="https://via.placeholder.com/350" alt="">
                        </picture>
                        <picture class="why-us__jpg why-us__jpg--eighth" data-name="images">
                            ...
                            <img loading="lazy" data-src="./src/img/photo/biały-domek-duże-patio/biały-domek-po-z-bliska-500.jpg" src="https://via.placeholder.com/350" alt="">
                        </picture>
                        <picture class="why-us__jpg why-us__jpg--ninth" data-name="images-left">
                            <source media="(max-width: 767px)" data-srcset="./src/img/photo/inne/img-300-small/biały-domek-po-(2)-300.webp" srcset="">
                            <img loading="lazy" data-src="./src/img/photo/biały-domek-duże-patio/biały-domek-po-500.jpg" src="https://via.placeholder.com/350" alt="">
                        </picture>
                    </section>
                </section>
                <section id="top" class="about-us  wrapper-style">
                    <header class="about-us__header">
                        ...
                        <p class="about-us__text about-us__text--first">Vi jobber med gjennomføring av prosjekter i Oslo
                            og
                            omegn, og vi
                            gjennomfører også langsiktige reiseprosjekter.Ved å bruke vår kunnskap og erfaring, hjelper
                            vi
                            kunder til å velge
                            den
                        ...
                        <p class="about-us__text about-us__text--second"> Takket være god kommunikasjon med medarbeidere
                            er
                            vi i
                    ...
                    <img class="about-us__image-svg" src="./src/img/photo/svg icon/jdproff_logo-about-svg.svg" alt="logo firmy jdproff">
                </section>
                <section id="middle" class="services wrapper-style">
                    ...
                    <section class="services__cards">
                        <div class="services__card">
                            <h3 class="services__subtitle">Innvendig og utvendig snekkerarbeid</h3>
                            <li class="services__list">Rehabilitering eller oppussing av eneboliger og leiligheter</li>
                            <li class="services__list">Nybygg og tilbygg</li>
                            <li class="services__list">Flytter og monterer nye vegger</li>
                            <li class="services__list">Oppbygging av vegger og konstruksjoner</li>
                            <li class="services__list">Montering og skifting av vinduer, dører og gulv</li>
                    ...
                    <ul class="steps__timeline">
                        <li data-tab-content="steps" class="steps__heading steps__heading--right">
                            <div class="steps__content steps__content--right">
                                ...
                                <h3>Kontakt oss</h3>
                                <p class="steps__text-paragraf steps__text-paragraf--right">Kontakt oss via
                                    søknadsskjemaet
                                    nederst på siden
                                    eller
                            ...
                            <div class="steps__svg steps__svg--right">
                                <svg class="svg-icon" width="36" height="36" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M508.2 387L485.95 487.8C482.684 502.05 470.16 505.02 455.49 505.02C203.2 505 3 308.8 3 56.5C3 41.84 12.969 29.3 27.22 26.05L125.02 2.80003C139.7 -0.601973 154.7 7.01803 160.8 20.92L207.32 129.42C212.758 142.2 209.09 157.09 198.34 165.87L144.5 207.1C178.48 276.32 232.76 332.6 302 366.6L346.08 312.8C354.768 302.02 369.77 298.29 382.55 303.825L490.05 350.335C503.1 357.2 511.6 372.4 508.2 387Z" stroke="#999999" stroke-width="10" />
                                    <defs>
                        ...
                        <li data-tab-content="steps" class="steps__heading steps__heading--left">
                            <div class="steps__content steps__content--left">
                                ...
                                <h3>Utførelse</h3>
                                <p class="steps__text-paragraf steps__text-paragraf--left">Vi fokuserer på
                                    profesjonalitet,
                                    nøyaktighet og
                        ...
                        <li data-tab-content="steps" class="steps__heading steps__heading--last">
                            ...
                            <div class="steps__svg">
                                <svg class="svg-icon" width="36" height="36" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10 256C10 114.6 114.6 10 256 10C397.4 10 502 114.6 502 256C502 397.4 397.4 502 256 502C114.6 502 10 397.4 10 256ZM164.1 325.5C158.3 318.8 148.2 318.1 141.5 323.9C134.8 329.7 134.1 339.8 139.9 346.5C162.1 372.1 200.9 400 255.1 400C311.1 400 349.8 372.1 372.1 346.5C377.9 339.8 377.2 329.7 370.5 323.9C363.8 318.1 353.7 318.8 347.9 325.5C329.9 346.2 299.4 368 255.1 368C212.6 368 182 346.2 164.1 325.5ZM176.4 176C158.7 176 144.4 190.3 144.4 208C144.4 225.7 158.7 240 176.4 240C194 240 208.4 225.7 208.4 208C208.4 190.3 194 176 176.4 176ZM300.8 233.6C318.4 210.1 353.6 210.1 371.2 233.6C376.5 240.7 386.5 242.1 393.6 236.8C400.7 231.5 402.1 221.5 396.8 214.4C366.4 173.9 305.6 173.9 275.2 214.4C269.9 221.5 271.3 231.5 278.4 236.8C285.5 242.1 295.5 240.7 300.8 233.6Z" stroke="#999999" stroke-width="10" />
                                </svg>
                            </div>
                        </li>
                    </ul>
                ...
                <section data-carousel class="reviews">
                    <header class="reviews__header">
                        <h2 data-text='Co sądzą o nas klienci' class="reviews__title title-heading">Co sądzą o nas
                            klienci
                        </h2>
                        <div class="reviews__buttons">
                            <button data-carousel-button="prev" class="reviews__button reviews__button--left"><img class="reviews__arrow" src="./src/img/photo/svg icon/arrow-left.svg" alt="przycisk w lewo do przewinięcia komentarzy"></button>
                            <button data-carousel-button="next" class="reviews__button reviews__button--right"><img class="reviews__arrow" src="./src/img/photo/svg icon/arrow-right.svg" alt="przycisk w prawo do przewinięcia komentarzy"></button>
                        </div>
                    </header>
                        ...
                        <div class="contact__container-b">
                            <form class="contact__form" method="POST" action="index.php">
                                <div class="contact__form-top">
                                    ...
                                    <input type="text" id="name" name="name" autocomplete="name" class="contact__form-input">
                                    <label for="email"  class="contact__form-label">Epost:</label>
                                    <input type="text" id="email" name="email" autocomplete="email" class="contact__form-input">
                                </div>
